 ...
 * Role Model
 * ----------
 * This file defines the Sequelize `Role` model, which represents the `role` table in the database.
 *
 * Contains:
 ...
 *
 * - `id_role`: Auto-incrementing integer, primary key.
...
Role.init(
    ...
    },
    {
        ...
        tableName: "role",    // Name of the table in the database (singular)
